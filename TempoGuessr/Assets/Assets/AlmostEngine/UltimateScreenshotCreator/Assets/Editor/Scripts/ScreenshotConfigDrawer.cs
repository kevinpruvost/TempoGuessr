    ...
    public class ScreenshotConfigDrawer
    {
        ...
        */
        ...
        public void DrawUsage()
        {
            ...
            if (usage == null)
            {
                usage = AssetUtils.GetOrCreate<PhotoUsageDescription>("Assets/AlmostEngine/UltimateScreenshotCreator/Assets/PhotoUsageDescription.asset", "iOSPhotoUsageDescription", "Assets/");
            }
            if (usage == null)
                return;
