...
namespace AlmostEngine.Screenshot
{
    public class ScreenshotNameParser
    {
        ...
        /// </summary>
        public static string ParseFileName(string screenshotName, ScreenshotResolution resolution, DestinationFolder destination, string customPath, TextureExporter.ImageFileFormat format, bool overrideFiles, System.DateTime time)
        {
            string filename = "";
            ...
            if (!overrideFiles)
            {
                return PathUtils.PreventOverride(filename);
            }
