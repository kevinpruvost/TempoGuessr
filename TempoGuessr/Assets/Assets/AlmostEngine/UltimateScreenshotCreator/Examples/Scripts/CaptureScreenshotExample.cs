	...
	public class CaptureScreenshotExample : MonoBehaviour
	{
		...
		void Update ()
		{
			if (Input.GetKeyDown (m_ShortcutA)) {
				...
				SimpleScreenshotCapture.CaptureScreen (m_FullpathA);
			}
			if (Input.GetKeyDown (m_ShortcutB)) {
				...
				SimpleScreenshotCapture.CaptureCameras (m_FullpathB, m_Width, m_Height, cameras, TextureExporter.ImageFileFormat.JPG, 70, 8);
			}
		}
	}
}
